...
#不加后面的也可以，不过哈希为空。
if($sample=~/YCM-DF/){$YCM{$gene}=1}elsif($YCM{$gene}){} else{$YCM{$gene}=0}
if($sample=~/CXY-FF/){$CXY{$gene}=1}elsif($CXY{$gene}){} else{$CXY{$gene}=0}
if($sample=~/NL-FF/){$NL{$gene}=1}elsif($NL{$gene}){} else{$NL{$gene}=0}
if($sample=~/WXH-DF/){$WXH{$gene}=1}elsif($WXH{$gene}){} else{$WXH{$gene}=0}
if($sample=~/FJY-DF/){$FJY{$gene}=1}elsif($FJY{$gene}){} else{$FJY{$gene}=0}
if($sample=~/CTX-DF/){$CTX{$gene}=1}elsif($CTX{$gene}){} else{$CTX{$gene}=0}
if($sample=~/DLJ-DF/){$DLJ{$gene}=1}elsif($DLJ{$gene}){} else{$DLJ{$gene}=0}
if($sample=~/LQQ-DF/){$LQQ{$gene}=1}elsif($LQQ{$gene}){} else{$LQQ{$gene}=0}
if($sample=~/YCJ-DF/){$YCJ{$gene}=1}elsif($YCJ{$gene}){} else{$YCJ{$gene}=0}
if($sample=~/CJL-FF/){$CJL{$gene}=1}elsif($CJL{$gene}){} else{$CJL{$gene}=0}
if($sample=~/ZCY-FF/){$ZCY{$gene}=1}elsif($ZCY{$gene}){} else{$ZCY{$gene}=0}
if($sample=~/ZLL-FF/){$ZLL{$gene}=1}elsif($ZLL{$gene}){} else{$ZLL{$gene}=0}
$hash{$gene}=1;
}
